 ...
 * @author
 */
Ext.define('Zstlweb.view.component.DateTime', {
			extend : 'Ext.form.field.Date',
			alias : 'widget.datetimefield',
			requires : ['Zstlweb.view.component.picker.DateTimePicker'],
			...
			createPicker : function() {
				...
				return new Zstlweb.view.component.picker.DateTimePicker({
							pickerField : me,
							ownerCt : me.ownerCt,
			 ...
			 */
			onExpand : function() {
				var me = this, value = me.getValue() instanceof Date ? me
						.getValue() : new Date();
